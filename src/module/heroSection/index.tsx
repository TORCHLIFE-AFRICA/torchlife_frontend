...
export default function HeroSectionPage() {
  return (
    <div>
      <HeroSection>
        <HeroText>
          <Font700Bold>Every mother deserves a safe delivery</Font700Bold>{" "}
          <br />
          <Font600Bold>
            Your kindness saves lives. Our verification process ensures every
            story is true.
          </Font600Bold>
          <HeroButtons>
        ...
        <ImageWrapper>
          <Image src={ImageSrc} alt="Pregnant mother holding belly" />
        </ImageWrapper>
      </HeroSection>
      ...
      <CTASection>
        ...
        <br />
        <Font600Medium20>
          Whether you are here to give or to receive, every act of kindness
          changes a story.
        </Font600Medium20>
        <HeroButtons>
          <Button variant="default">Start a Campaign</Button>
